  ...
  <body>
    <header>
      ...
      <section class="textos-header">
        <h1>Contacto</h1>
        <h2>nos agrada que nos contactes</h2>
      </section>
    ...
    <main>
      <section class="contacto">
        <div class="contenido">
          <h2>Estamos para ayudarte, contamos con un excelente talento humano, queremos ser tu aliado a la hora de tomar las mejores decisiones financieras, no dudes en contactarnos siempre que lo necesites.</h2>
